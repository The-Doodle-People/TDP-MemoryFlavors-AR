...
public class TouchHandler : MonoBehaviour
{
    void OnTouchPress()
    {
        ...
        {
            // Check if the hit object has an AstronautController component (teacher's comment)
            if (hitInfo.collider.GetComponent<BriyaniController>() != null)
            {
                hitInfo.collider.GetComponent<BriyaniController>().Interact();
            }
        }
